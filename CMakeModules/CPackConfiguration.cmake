set(CPACK_PACKAGE_DESCRIPTION_SUMMARY "StromRein Media Player")
set(CPACK_PACKAGE_VENDOR "Jellyfin")
set(CPACK_PACKAGE_NAME "StromRein Media Player")
...
set(CPACK_PACKAGE_FILE_NAME "StromReinMediaPlayer-${VERSION_STRING}-${CPACK_SYSTEM_NAME}")
set(CPACK_SOURCE_PACKAGE_FILE_NAME "StromReinMediaPlayer-${VERSION_STRING}-src")

set(CPACK_PACKAGE_INSTALL_DIRECTORY "StromReinMediaPlayer")
...
if(WIN32)
  ...
  include(CPack)
  cpack_add_component(Core DISPLAY_NAME "StromRein Media Player" DESCRIPTION "StromRein Media Player (Core Application)" REQUIRED)
endif(WIN32)